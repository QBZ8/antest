...
//char message[20]="";
  ...
  while (1)
  {
	...
	/*duty=(10*count/20.00+2.5)/100*2000;
	__HAL_TIM_SET_COMPARE(&htim3,TIM_CHANNEL_1,duty);
	  for(uint8_t i=0;i<64;i++)
	  {
		...
		// OLED_PrintString(0,0,"左偏角过大",&ZUO16x16,OLED_COLOR_NORMAL);
		// OLED_PrintString(0,20,"右偏角过大",&YOU16x16,OLED_COLOR_NORMAL);
		// OLED_PrintString(0,40,"姿态正常",&ZHE16x16,OLED_COLOR_NORMAL);
