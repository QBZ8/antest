...
#include "chassis_power_controll.h"
...
void lk_send_can2(mt_cmd_id_e mt_cmd_id, int16_t motor1, int16_t motor2, int16_t motor3);
...
//	chassis_move_init->chassis_RC = get_remote_control_point();
	...
	for(int i=0;i<500;i++)
	lk_send_can2(LK_MULTIPLE_ID,0,0,0);
