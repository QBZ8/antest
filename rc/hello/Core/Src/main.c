...
/*void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	 ...
	 {
		 HAL_GPIO_WritePin(LED_BULLE_GPIO_Port,LED_BULLE_Pin,state);
	 }
...
int main(void)
{
  ...
  while (1)
  {
	 ...
	 /* HAL_UART_Transmit(&huart2,(uint8_t*)message,strlen(message),100);
	  ...
	  /*HAL_GPIO_WritePin(LED_BULLE_GPIO_Port,LED_BULLE_Pin,GPIO_PIN_SET);
	  HAL_Delay(2000);
	  HAL_GPIO_WritePin(LED_BULLE_GPIO_Port,LED_BULLE_Pin,GPIO_PIN_RESET);
	  HAL_Delay(2000);*/
