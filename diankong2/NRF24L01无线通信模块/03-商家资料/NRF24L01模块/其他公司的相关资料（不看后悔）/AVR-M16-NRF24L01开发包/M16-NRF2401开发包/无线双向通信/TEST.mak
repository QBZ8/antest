...
test.o: C:\iccv7avr\include\iom16v.h C:\iccv7avr\include\macros.h
test.o:	C:\DOCUME~1\Administrator\桌面\无线双向通信\test.c
	$(CC) -c $(CFLAGS) C:\DOCUME~1\Administrator\桌面\无线双向通信\test.c
