	...
	.dbfile F:\开发板配套资料\开发板备份\AVR24L01\无线温度传感\接收\jieshou.c
...
; 		{
	.dbline 323
; 			R_S_Byte((RxBuf[2]<<4)|RxBuf[1]);//整数位
	lds R2,_RxBuf+1
	lds R16,_RxBuf+2
	andi R16,#0x0F
	swap R16
...
; 		display() ;  
	xcall _display
	.dbline 331
; 	if(((RxBuf[2]<<4)|RxBuf[1])>=53)//大于35度时报警，0x30转换成10进制为48
	lds R2,_RxBuf+1
	lds R24,_RxBuf+2
	andi R24,#0x0F
	swap R24
