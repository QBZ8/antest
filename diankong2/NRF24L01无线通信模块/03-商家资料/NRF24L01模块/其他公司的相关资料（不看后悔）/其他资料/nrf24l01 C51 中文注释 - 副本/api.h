...
sbit CSN  = P1^3;  // Slave Select pin, (output to CSN, nRF24L01)
sbit IRQ  = P1^4;  // Interrupt signal, from nRF24L01 (input)
...
//sbit MOSI = P1^5;  // Serial Clock pin, (output)
//sbit MISO = P1^6;  // Master In, Slave Out pin (input)
//sbit IRQ  = P1^7;  // Interrupt signal, from nRF24L01 (input)
